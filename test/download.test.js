...
const testCases = [
  ...
  { version: "1.5.1", platform: "linux", arch: "x64", expected: "v1.5.1/merkely_1.5.1_linux_amd64.tar.gz" },
...
//https://github.com/merkely-development/cli/releases/download/v1.5.1/merkely_1.5.1_linux_x64.tar.gz
